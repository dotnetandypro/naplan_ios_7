...
class DragToGroupOptionsReview extends StatefulWidget {
  // Review: Class renamed to DragToGroupOptionsReview
  ...
  const DragToGroupOptionsReview(
      {Key? key,
  ...
  @override
  _DragToGroupOptionsReviewState createState() =>
      _DragToGroupOptionsReviewState();
}

class _DragToGroupOptionsReviewState extends State<DragToGroupOptionsReview> {
