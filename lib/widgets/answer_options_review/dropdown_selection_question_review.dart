...
class DropdownSelectionQuestionReview extends StatefulWidget {
  ...
  const DropdownSelectionQuestionReview(
      {Key? key,
  ...
  @override
  _DropdownSelectionQuestionReviewState createState() =>
      _DropdownSelectionQuestionReviewState();
}

class _DropdownSelectionQuestionReviewState
    extends State<DropdownSelectionQuestionReview> {
  late List<String>
      selectedAnswers; // Changed from Map<String, String> to List<String>
  ...
  @override
  void didUpdateWidget(DropdownSelectionQuestionReview oldWidget) {
