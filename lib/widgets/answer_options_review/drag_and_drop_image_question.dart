...
class DragAndDropImageQuestionReview extends StatelessWidget {
  ...
  const DragAndDropImageQuestionReview(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    return _DragAndDropImageReviewContent(
...
class _DragAndDropImageReviewContent extends StatelessWidget {
  final int questionId;
  final String questionText;
  final List<String> categories;
  final List<String> options;
  ...
  const _DragAndDropImageReviewContent(
      {Key? key,
      required this.questionId,
      required this.questionText,
      required this.categories,
