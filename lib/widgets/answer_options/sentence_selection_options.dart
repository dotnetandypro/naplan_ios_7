...
class SentenceSelectionOptions extends StatefulWidget {
  ...
  const SentenceSelectionOptions(
      {Key? key,
  ...
  @override
  _SentenceSelectionOptionsState createState() =>
      _SentenceSelectionOptionsState();
}

class _SentenceSelectionOptionsState extends State<SentenceSelectionOptions> {
