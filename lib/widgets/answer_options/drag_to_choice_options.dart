...
class DragToChoiceOptions extends StatefulWidget {
  ...
  @override
  _DragToChoiceOptionsState createState() => _DragToChoiceOptionsState();
}

class _DragToChoiceOptionsState extends State<DragToChoiceOptions> {
  ...
  @override
  void didUpdateWidget(covariant DragToChoiceOptions oldWidget) {
