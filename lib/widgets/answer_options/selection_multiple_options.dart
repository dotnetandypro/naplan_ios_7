...
class SelectionMultipleOptions extends StatefulWidget {
  ...
  @override
  _SelectionMultipleOptionsState createState() =>
      _SelectionMultipleOptionsState();
}

class _SelectionMultipleOptionsState extends State<SelectionMultipleOptions> {
