...
class DragToOrderOptions extends StatefulWidget {
  ...
  @override
  _DragToOrderOptionsState createState() => _DragToOrderOptionsState();
}

class _DragToOrderOptionsState extends State<DragToOrderOptions> {
